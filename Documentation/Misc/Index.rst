...
* I get errors when trying to run the importer
...
The git repository of `ext:news_ttnewsimport <https://github.com/Kephson/news_falttnewsimport>`_ can be found on Github.
